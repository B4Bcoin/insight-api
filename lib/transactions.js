...
TxController.prototype.transformTransaction = function(transaction, options, callback) {
  ...
  if(transaction.height >= 0) {
    confirmations = this.node.services.b4bd.height - transaction.height + 1;
  }
...
TxController.prototype.transformOutput = function(options, output, index) {
  ...
  if (output.address) {
    ...
    var address = b4bcore.Address(output.address); //TODO return type from b4bcore-node
...
TxController.prototype.transformB4bTransaction = function(transaction) {
